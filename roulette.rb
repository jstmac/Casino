...
class Roulette
  ...
  def get_wager
    system "clear"
    seperator
    print "                  You have #{@player_wallet}, how much would you like to wager (or QUIT)?: ".colorize(:blue)
    seperator
    ...
    when bet.to_i > @player_wallet
      seperator
      puts "              I'm sorry #{@name} you dont seem to have enough to cover the bet.".colorize(:blue)
      seperator
      sleep(3)
      get_wager
    when bet.to_i <= @player_wallet  
